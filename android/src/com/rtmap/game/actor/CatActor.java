...
public class CatActor extends Actor {
    ...
    private void initResources() {
        ...
        setPosition(width / 2, height * 0.05f);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (!isDown)
            batch.draw(normal, width / 2 - normal.getRegionWidth() / 2, height * 0.1f, normal.getRegionWidth(), normal.getRegionHeight());
        else
            batch.draw(press, width / 2 - press.getRegionWidth() / 2, height * 0.1f, press.getRegionWidth(), press.getRegionHeight());
    }
